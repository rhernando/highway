...
/**
 * This is the item provider adapter for a {@link PetriNet.PetriNet.Arc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_In_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_In_feature", "_UI_Arc_type"),
				 PetriNetPackage.Literals.ARC__IN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_Out_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_Out_feature", "_UI_Arc_type"),
				 PetriNetPackage.Literals.ARC__OUT,
				 true,
				 false,
				 true,
				 null,
