...
/**
 * This is the item provider adapter for a {@link highwayproj.highway.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_belongsTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_belongsTo_feature", "_UI_Signal_type"),
				 HighwayPackage.Literals.SIGNAL__BELONGS_TO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HighwayPackage.Literals.SIGNAL__NAME,
				 true,
				 false,
				 false,
