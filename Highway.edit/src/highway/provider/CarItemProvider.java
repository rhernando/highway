...
public class CarItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsInNodePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Is In Node feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsInNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Car_isInNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Car_isInNode_feature", "_UI_Car_type"),
				 HighwayPackage.Literals.CAR__IS_IN_NODE,
				 true,
				 false,
				 true,
				 null,
