...
public class PetriNetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetriNetPackage.PETRI_NET_ROOT: {
				PetriNetRoot petriNetRoot = (PetriNetRoot)theEObject;
				T result = casePetriNetRoot(petriNetRoot);
	 ...
	 * @generated
	 */
	public T casePetriNetRoot(PetriNetRoot object) {
		return null;
	}
